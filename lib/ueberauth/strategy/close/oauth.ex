defmodule Ueberauth.Strategy.Close.OAuth do
  @moduledoc """
  An implementation of OAuth2 for Close.
  ...
  alias Ueberauth.Strategy.Close.OAuthStrategy
  ...
  @doc """
  Construct a client for requests to Close.

  This will be setup automatically for you in `Ueberauth.Strategy.Close`.
